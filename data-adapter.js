...
const DEFAULT_LIVE_UNIVERSE = [
  ...
  "OPUSDT", "FILUSDT", "ETCUSDT", "HBARUSDT", "ICPUSDT",
  "INJUSDT", "TIAUSDT", "SEIUSDT", "AAVEUSDT", "ENAUSDT",
  "PENDLEUSDT", "ORDIUSDT", "JUPUSDT", "PYTHUSDT", "WIFUSDT",
  "PEPEUSDT", "FETUSDT", "RENDERUSDT", "ATOMUSDT", "ALGOUSDT",
  "VETUSDT", "GALAUSDT", "SANDUSDT", "MANAUSDT", "RUNEUSDT",
  "LDOUSDT", "STXUSDT", "IMXUSDT", "MKRUSDT", "ONDOUSDT",
];
